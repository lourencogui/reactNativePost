...
export default class App extends Component {
  state = {
    posts: [
    { id: 0, title: 'Aprendendo React Native', author: 'Guilherme Lourenço', description: 'Lorem ipsum nec a metus senectus nunc fringilla nec, ac tortor congue suspendisse neque sed rhoncus viverra, vulputate lobortis diam a sociosqu ultricies ante. ut duis aenean senectus, tristique urna. ' },
      ...
      <View style={styles.container}>
        ...
        <ScrollView>
          {this.state.posts.map(post => (
            return <Post key={post.id} title={post.title} author={post.author} description={post.description} />
          ))}
        </ScrollView>
      </View>
    );
